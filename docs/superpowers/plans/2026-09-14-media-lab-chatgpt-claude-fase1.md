...
- [ ] `abrir`: con la cortina de notificaciones desplegada no ve Instagram y sale con 4 (bien, falla cerrado). Valorar `cmd statusbar collapse` antes de buscar Instagram (no despierta ni desbloquea).
